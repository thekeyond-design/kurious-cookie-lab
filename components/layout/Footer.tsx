...
export function Footer() {
  return (
    <footer className="text-white mt-auto" style={{ background: "#1a1a4e", fontFamily: FONT }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        {Object.entries(LINKS).map(([section, links]) => (
          <div key={section} className="space-y-3">
            <h4 className="text-xs font-bold uppercase tracking-widest text-white/30" style={{ fontFamily: FONT }}>
              {section}
            </h4>
